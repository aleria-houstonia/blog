    ...
    return (
        <div className={styles.blogDesc}>
            ...
            <div className={styles.blogDescText}>
                ...
                занималась "магическими" обрядами, большая часть из которых
                носила весьма фривольный характер… С приходом христианства
                обычаи приняли существенно более целомудренный, но не менее
                веселый характер. Словом "калядань-чи" мордва называет
                рождественский сочельник. Этот день ассоциировался и у эрзя, и у
                мокша с нарождением солнца после долгой зимы и сулил рачительным
                хозяевам благополучие. Во время празднования "калядань-чи" дети
                с весёлыми песнями ходили по домам деревенских жителей, которые
